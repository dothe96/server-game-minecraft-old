...
<!--[if gt IE 8]><!--> <html lang="vi" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#" class="no-js"><!--<![endif]-->
	...
	<link href="../assetslg/css/bootstrap.css" rel="stylesheet">
		...
		<title>Tải Game - Tải Minecraft - Server Minecraft Việt Nam - Minelg.com</title>
		...
		<div class="container1">
                <div class="menutong">
                    <ul class="menulg1"> <!--edit mac dinh-->
                        ...
                        <li class="macdinhlg"><a href="http://minelg.com/tai-game"><i class="fa fa-download"></i> Tải Game</a></li>
	...
	<div id="content">
		<div id="inner-lg" class="wrap2 clearfix">
			<div class="nentrangdad nentrang">
					<font size="5"><i class="fa fa-download"></i> Tải game</font>
			</div>
		</div>
	</div>
	<div id="content2">
...
<div id="main" class="ninecol first clearfix" role="main">
	<div class="inner-bg">
		...
		<h1><span style="color: #424242; font-weight: bold;"><div class="minimenu"><font color="#F2F2F2"><i class="fa fa-cloud-download"></i></font> Tải game và java</div></span></h1>
				<div class="bovien">
						<div class="vbcenter" style="text-align: justify;">Minecraft trên nền tảng PC đang được sử dụng phổ biến hiện nay. Server <a href="http://minelg.com">Minelg.com</a> cung cấp cho bạn những phiên bản Minecraft đầy đủ để tải về. Để game có thể chạy máy tính của bạn bắt buộc phải cài java. Hãy lựa chọn những phiên bản sau đây!<br></div>
						<div class="vbcenter"><font style="color: #0B181F; font-weight: bold;">Tải game minecraft bản windows</font></div>
						<a href="Minecraft_Minelg.exe" style="text-decoration: none;"><div class="taive"><i class="fa fa-download"></i> Minecraft windows</div></a>
						<div class="vbcenter"><font style="color: #0B181F; font-weight: bold;">Tải Java</font></div>
						<div class="taive2">
							<a href="Java_32.exe" style="text-decoration: none;"><div class="tvj1">Java 32 bit</div></a><a href="Java_64.exe" style="text-decoration: none;"><div class="tvj2">Java 64 bit</div></a>
						</div>
						<br>
					<font style="text-align: justify; font-size: 18px;">Hướng dẫn cách vào game:<br></font>
					<font style="text-align: justify; font-size: 16px; color: black;">Bước 1: Sau khi tải game về máy tính, các bạn mở lên sẽ thấy giao diện như sau:<br></font>
					<img class="chenanh" src="../img/openmc.png"/><br>
					<font style="text-align: justify; font-size: 16px; color: black;">Bước 2: Chọn phiên bản server, minelg là 1.10.2:<br></font>
					<img class="chenanh" src="../img/openmc1.jpg"/><br>
					<font style="text-align: justify; font-size: 16px; color: black;">Bước 3: Chọn "chơi mạng" nếu chơi online:<br></font>
					<img class="chenanh" src="../img/openmc2.jpg"/><br>
					<font style="text-align: justify; font-size: 16px; color: black;">Bước 4: Chọn "thêm máy chủ" để tìm kiếm server:<br></font>
					<img class="chenanh" src="../img/openmc3.jpg"/><br>
					<font style="text-align: justify; font-size: 16px; color: black;">Bước 5: Nhập IP của server, ip minelg: play.minelg.com :<br></font>
					<img class="chenanh" src="../img/openmc4.jpg"/><br>
					<font style="text-align: justify; font-size: 16px; color: black;">Bước 6: Click vào server và bắt đầu chơi:<br></font>
					<img class="chenanh" src="../img/openmc5.jpg"/><br>
					<font style="text-align: justify; font-size: 18px;">Chúc các bạn thành công, và bây giờ hãy tham gia vào cộng đồng Minecraft nào!<br></font><p></p>
				</div><!--bovien-->
				<p></p>
