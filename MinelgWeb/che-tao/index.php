...
<!--[if gt IE 8]><!--> <html lang="vi" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#" class="no-js"><!--<![endif]-->
	...
	<link href="../assetslg/css/bootstrap.css" rel="stylesheet">
		...
		<title>Công Thức Chế Tạo Minecraft - Server Minecraft Việt Nam - Minelg.com</title>
	...
	<div id="content">
		<div id="inner-lg" class="wrap2 clearfix">
			<div class="nentrangdad nentrang">
					<font size="5"><i class="fa fa-table"></i> Chế tạo</font>
			</div>
		</div>
	</div>
	<div id="content2">
...
<div id="main" class="ninecol first clearfix" role="main">
	<div class="inner-bg">
		...
		<h1><span style="color: #424242; font-weight: bold;"><div class="minimenu3"><font color="#F2F2F2"><i class="fa fa-gavel"></i></font> Công thức chế tạo</div></span></h1>
				<div class="bovien">
					<p>Chế tạo đồ minecraft là phương pháp tạo ra những vật phẩm (items) cao cấp từ những vật phẩm thô. Có hai bàn chế tạo: 1 trong hòm đồ (phím E) là bàn chế tạo có 4 ô, 2 bàn chế tạo 9 ô chế tạo đồ phức tạp hơn. Tại server minelg.com cung cấp đầy đủ công thức chế tạo đồ minecraft. Hãy tìm công thức của vật phẩm bạn muốn bên dưới!</p>
						<script src="static/js/jquery.js"></script><br />
					    <script src="static/js/output.js"></script><br />
					    <script src="static/js/construct.js"></script>
					    <link rel="stylesheet" href="static/css/chetao.css" type="text/css" media="screen" charset="utf-8">
</p>
<div class="content">
<div class="col-main">
<div class="construct-wrapper">
<div class="top-wrapper">
<h3 id="hdr">Đầy đủ công thức chế tạo minecraft:</h3>
<div style="display: none" id="topContent" class="top-content">
<h2 id="itemName" class="item-name"></h2>
<p>                        <img id="craft" src="/che-tao/"" /><br />
                        <img id="mainImage" src="/che-tao/"" class="main-image" />
                    </div>
</p></div>
<div id="construct" class="construct"></div>
<div class="clear"></div>
</p></div>
<div class="bottom-blocks">
<div class="block-decor l"></div>
<div class="block-decor r"></div>
<div class="block l">
                </div>
</p></div>
