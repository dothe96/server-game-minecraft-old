...
<!--[if gt IE 8]><!--> <html lang="vi" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#" class="no-js"><!--<![endif]-->
	...
	<link href="../assetslg/css/bootstrap.css" rel="stylesheet">
		...
		<title>Lỗi - Minelg.com - Minecraft Việt Nam</title>
	...
	<div id="content">
		<div id="inner-lg" class="wrap2 clearfix">
			<div class="nentrangdad nentrang">
					<font size="5"><i class="fa fa-times"></i> Lỗi !!!</font>
			</div>
		</div>
	</div>
	<div id="content2">
...
<div id="main" class="ninecol first clearfix" role="main">
	<div class="inner-bg">
		...
		<h1><span style="color: #424242; font-weight: bold;"><div class="minimenu"><font color="#F2F2F2"><i class="fa fa-frown-o"></i></font> Có lỗi xảy ra</div></span></h1>
				<div class="bovien">
						
					<p></p><center><font style="color: red; font-size: 18px;">Địa chỉ trang web bạn truy cập không tồn tại!</font>
					<a href="https://minelg.com"  style="text-decoration: none;"><div class="taive">Về Trang Chủ</div></a></center>
				</div><!--bovien-->
				<p></p>
