...
<meta property="og:url" content="http://minelg.com" />
		...
		<div class="container1">
                <div class="menutong">
                    <ul class="menulg1"> <!--edit mac dinh-->
                        <li class="macdinhlg"><a href="http://minelg.com"><i class="fa fa-home"></i> Home</a></li>
				...
				<div class="clear"></div>
										...
										<!--<p id="logo"><a href="https://minelg.tk" rel="nofollow">

											<img src="imglg/logolg.png" alt="logo" title="Server Minecraft Việt Nam"  itemprop="headline">
...
<!--test> ----
	<header class="header" itemscope="itemscope" itemtype="http://schema.org/WPHeader" role="banner">
				...
				<div id="inner-lg" class="wrap clearfix">				
					
<div class="nentrangdad nentrang">
					<font size="5"><i class="fa fa-home"></i> Trang Chủ</font>
</div>
			...
			<div class="nentrangdad nentrang">
				...
				<div id="main" class="ninecol first clearfix" role="main">
					...
					<article id="post-63" class="clearfix post-63 page type-page status-publish has-post-thumbnail hentry" role="article" itemscope itemtype="http://schema.org/BlogPosting">
							...
							<h1 class="page-title" itemprop="headline">Trang Chủ</h1>

						</header> -->
						<!--<section class="entry-content clearfix" itemprop="articleBody">
							
			<div class="kk-star-ratings  top-right rgt" data-id="63">
			    <div class="kksr-stars kksr-star gray">
			        <div class="kksr-fuel kksr-star yellow" style="width:0%;"></div>
			        <!-- kksr-fuel --><a href="#1"></a><a href="#2"></a><a href="#3"></a><a href="#4"></a><a href="#5"></a>
			    <!--</div>
			    <!-- kksr-stars -->
			    <!--<div class="kksr-legend"><div vocab="http://schema.org/" typeof="Blog">    <div property="name" class="kksr-title">Trang Chủ</div>    <div property="aggregateRating" typeof="AggregateRating"><span property="ratingValue">3.27</span> (65.42%) <span property="ratingCount">277</span> votes            <meta property="bestRating" content="5"/>            <meta property="worstRating" content="1"/>    </div></div></div>
			    <!-- kksr-legend -->
			<!--</div>
			<!-- kk-star-ratings -->
			<h1><span style="color: #424242; font-weight: bold;"><div class="minimenu"><font color="#F2F2F2"><i class="fa fa-lightbulb-o "></i></font> Minecraft Là Gì?</div></span></h1>
<div class="bovien"><p>Minecraft là một trò chơi điện tử độc lập trong một Thế giới mở. Ban đầu nó được tạo ra bởi lập trình viên người Thụy Điển Markus &#8220;Notch&#8221; Persson và sau đó được phát triển và phát hành bởi một công ty ở Thụy Điển là Mojang. Khả năng sáng tạo và xây dựng Minecraft cho phép người chơi xây dựng công trình bằng cách xây các khối kết cấu trong một thế giới 3D được tạo ra một cách thủ tục. Các hoạt động khác trong game bao gồm tìm kiếm, thu thập tài nguyên, chế tạo, chiến đấu. Có nhiều chế độ chơi có sẵn, gồm chế độ sinh tồn, khi mà người chơi phải tìm tài nguyên để xây dựng thế giới và duy trì sức khỏe, chế độ sáng tạo, nơi người chơi tài nguyên không giới hạn để xây dựng và có khả năng bay, và chế độ phiêu lưu, nơi người chơi chơi các bản đồ được người khác tạo ra. Phiên bản PC của trò chơi còn nổi tiếng với các mod, cho phép có thêm nhiều công cụ mới, nhân vật và nhiệm vụ cho trò chơi. Ở server Minelg các chế độ đã được phong phú hóa lối chơi bằng những plugins hỗ trợ từ đối tác Spigot.</p>
<p style="text-align: right;">(Nguồn Wikipedia - Editor: Đỗ Thế)</p><br>
<center><iframe width="80%" height="315px" src="https://www.youtube.com/embed/EA1awLDmu5E" frameborder="0" allowfullscreen></iframe></center>
<p></p>
</div>
<h1><span style="color: #424242; font-weight: bold;"><div class="minimenu2"><font color="#F2F2F2"><i class="fa fa-th-large"></i></font> Giới thiệu Server MineLG</div></span></h1>
<div class="bovien"><p style="text-align: justify;">Server Minecraft MineLG là server minecraft việt nam. Đây là nơi dành cho những người chơi sáng tạo, chăm chỉ để tạo nên những kì quan, hay đơn giản là được làm chủ thế giới của mình, với những chế độ chơi như: <big><font font-weight="bold" color="red">Survival</font></big>, <big><font font-weight="bold" color="green">Prison</font></big> (Sắp ra mắt), <big><font font-weight="bold" color="#FFBF00">Skyblock</font></big> (Sắp ra mắt), còn chờ gì nữa hãy tham gia và kết bạn trong thế giới tuyệt vời của những người cùng đam mê nào!</p>
<h2 style="text-align: center;"><span style="color: #04B4AE;">ip: play.minelg.com</span></h2><img class="chenanh" src="imglg/anhlg.jpg"/></div>
<h1><span style="color: #424242; font-weight: bold;"><div class="minimenu3"><font color="#F2F2F2"><i class="fa fa-camera-retro"></i></font> Hình ảnh ingame</div></span></h1>
<div class="bovien">
</div>
			</section> 
<p></p>
